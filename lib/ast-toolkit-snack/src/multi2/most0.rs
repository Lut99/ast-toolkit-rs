...
pub struct Most0<C, F, S> {
    comb: C,
    _f:   PhantomData<F>,
    _s:   PhantomData<S>,
}
impl<'t, C, F, S> Combinator2<'t, F, S> for Most0<C, F, S>
where
    F: Clone,
    S: Clone,
    C: Combinator2<'t, F, S>,
...
/// use ast_toolkit_snack::multi2::most0;
...
/// ```
#[inline]
pub const fn most0<'t, C, F, S>(comb: C) -> Most0<C, F, S>
where
    C: Combinator2<'t, F, S>,
    F: Clone,
    S: Clone,
{
    Most0 { comb, _f: PhantomData, _s: PhantomData }
}
