...
//     let span = Span::raw_ranged(function_name!(), "Hello there!", ByteUsize(0)..ByteUsize(5));
//     assert_eq!(span.spanned(), "Hello");

//     let span = Span::raw_ranged(function_name!(), "Hello there!", ByteUsize(6)..);
